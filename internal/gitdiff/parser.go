...
// Parse returns a channel of files parsed from a patch. Callers must drain the
// channel. The returned error only covers initializing the reader; later
// parsing errors can skip files or close the channel without being reported.
