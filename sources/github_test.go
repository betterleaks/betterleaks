...
func TestGitHub_scanRepo_prefilterSkipsRepoByResourceAttrs(t *testing.T) {
	...
	src := &GitHub{ShouldSkip: skip, Resources: GitHubResourceSet{GitHubResourceTypeRepos: true}} //nolint:exhaustruct
...
// Before A2 the fix (TryGo→Go), repos beyond the worker limit were silently
// dropped.
